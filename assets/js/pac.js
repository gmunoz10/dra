$(function() {
    ...
    function agregar_fila() {
        ...
        $("#table_multi tbody tr").each(function(e, v) {
            if ($(this).find('.desc_pac').val() == "" && $(this).find('.fech_pac').val() == "" && $(this).find('.docu_pac').get(0).files.length === 0) {
                create = false;
                return;
            }
        });
    ...
    $(document).on('change, keyup', '.codi_gpa, .fech_pac, .desc_pac, .docu_pac', function () {
    ...
    $("#submit_multi_pac").click(function() {
        ...
        $("#table_multi tbody tr").each(function(e, v) {
            tr = $(this);
            valid_row = true;
            if (tr.find('.desc_pac').val() == "" && tr.find('.fech_pac').val() == "" && tr.find('.docu_pac').get(0).files.length === 0) {
                return true;
            }
