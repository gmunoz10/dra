                ...
                <div class="row">
                	<div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="nomb_gpa">
                        </div>
                  	</div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input class="form-control" name="link" id="enlace_gpa" readonly="">
                            <span class="input-group-btn">
                                <button class="btn btn-default btn-copiar" type="button" data-clipboard-target="#enlace_gpa" data-toggle="tooltip" data-placement="top" title="Copiar"><i class="fa fa-clipboard" aria-hidden="true"></i></button>
                              </span>
                          <span class="input-group-btn">
