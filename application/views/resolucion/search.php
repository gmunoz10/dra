		...
		<div class="row">
			<div class="box-content col-md-8 col-md-offset-2" style="line-height: 1.42857143;">
                ...
                <?php if(check_permission(REGISTRAR_RESOLUCION)) { ?>
				    <button id="btn_resolucion" class="btn btn-orange" style="color: black !important; font-weight: bold;">Nueva resolución</button>
                <?php } ?>
				<br>
        ...
        <form id="form_resolucion" method="post" action="" enctype="multipart/form-data" accept-charset="utf-8">
          ...
          <div class="modal-header">
            ...
            <div class="modal-footer">
                ...
                <button id="submit_multi_resolucion" type="button" class="btn btn-success" style="margin-top: 20px; display: none;">Guardar</button>
            </div>
        </form>
    </div>
  </div>
