	...
	<section>
		<div class="row">
			<div class="box-content box-bold col-md-8 col-md-offset-2" style="line-height: 1.42857143;">
			    ...
			    <h3 class="title-sisgedo" style="margin-bottom: 5px;"><a href="<?= base_url(). "tema_agrario/" . $tema_agrario->codi_tea ?>"><?= $tema_agrario->titu_tea ?></a></h3>
			    <p style="color: #666"><span><?= $tema_agrario->nume_tea ?></span> - <i>Publicado por <b><?= $tema_agrario->nomb_usu ?></b></i><span class="pull-right"><i class="fa fa-clock-o" aria-hidden="true"></i> <i>Fecha de publicación: <?= date("d/m/Y h:i A", strtotime($tema_agrario->fech_tea)) ?></i></span></p>
			    <hr>
				<div class="col-lg-12 text-center">
					<img src="<?= asset_url() . "tema_agrario/" . $tema_agrario->imag_tea ?>" class="img-thumbnail img-responsive">
	            </div>
				<div class="col-lg-12" style="margin-top: 15px;">
					<?= $tema_agrario->cont_tea ?>
		  		</div>
				<div class="col-lg-12" style="margin-top: 15px;">
			  		<b><i>Comparte en: </i></b>
				...
				<?php if ($tema_agrario->id_fb != "") { ?>
		  		<br>
		  		<br>
			    <hr>
				<div class="col-lg-12 text-center">
					<div class="fb-comments" data-href="https://www.facebook.com/<?= $pageId ?>/posts/<?= str_replace($pageId."_", "",$tema_agrario->id_fb) ?>" data-numposts="5">
					</div>
		  		</div>
				<?php } ?>
