...
// COMISION
defined('BUSCAR_COMISION')  				OR define('BUSCAR_COMISION', 141);
defined('LEER_COMISION')        			OR define('LEER_COMISION', 142);
defined('REGISTRAR_COMISION')   			OR define('REGISTRAR_COMISION', 143);
defined('MODIFICAR_COMISION')   			OR define('MODIFICAR_COMISION', 144);
defined('HABILITAR_COMISION')   			OR define('HABILITAR_COMISION', 145);
defined('DESHABILITAR_COMISION')			OR define('DESHABILITAR_COMISION', 146);
defined('ELIMINAR_COMISION')   				OR define('ELIMINAR_COMISION', 147);