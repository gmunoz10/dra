...
$route['pap/(:num)'] = "PapController/pap/$1";
$route['pap/paginate_portal'] = "PapController/paginate_portal";
...
$route['pap'] = "PapController/index";
$route['pap/paginate'] = "PapController/paginate";
$route['pap/check_nume_pap'] = "PapController/check_nume_pap";
$route['pap/check_nume_pap_actualizar'] = "PapController/check_nume_pap_actualizar";
$route['pap/save'] = "PapController/save";
$route['pap/save_multi'] = "PapController/save_multi";
$route['pap/update'] = "PapController/update";
$route['pap/habilitar'] = "PapController/habilitar";
$route['pap/deshabilitar'] = "PapController/deshabilitar";
$route['pap/eliminar'] = "PapController/eliminar";

$route['grupo_pap'] = "PapController/grupo";
$route['grupo_pap/paginate'] = "PapController/paginate_grupo";
$route['grupo_pap/check_nomb_gpa'] = "PapController/check_nomb_gpa";
$route['grupo_pap/check_nomb_gpa_actualizar'] = "PapController/check_nomb_gpa_actualizar";
$route['grupo_pap/save'] = "PapController/save_grupo";
$route['grupo_pap/update'] = "PapController/update_grupo";
$route['grupo_pap/habilitar'] = "PapController/habilitar_grupo";
$route['grupo_pap/deshabilitar'] = "PapController/deshabilitar_grupo";
$route['grupo_pap/eliminar'] = "PapController/eliminar_grupo";